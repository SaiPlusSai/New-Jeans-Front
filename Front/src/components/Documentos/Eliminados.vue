...
export default {
  ...
  methods: {
    ...
    try {
      ...
      const response = await fetch('https://newjeans-back.onrender.com/api/documentos/eliminados', {
        headers: {
    ...
    try {
      ...
      const response = await fetch(`https://newjeans-back.onrender.com/api/documentos/${codigo}/restaurar`, {
        method: 'PATCH',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
