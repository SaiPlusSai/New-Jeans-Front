...
const fetchConsultas = async () => {
  try {
    const response = await axios.get('https://newjeans-back.onrender.com/api/reportes/consultas', {
        headers: {
...
const fetchDocs = async () => {
  try {
    const response = await axios.get('https://newjeans-back.onrender.com/api/reportes/documentos', {
        headers: {
            Authorization: `Bearer ${token}`
        }
    });
...
const applyFilters = async () => {
    if(selectedTipo.value != null && searchAnio.value != null){
        ...
        if(selectedTipo.value != null){
            try {
                const response = await axios.get(`https://newjeans-back.onrender.com/api/reportes/documentos/tipo/${selectedTipo.value}`, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
            ...
            if(searchAnio.value < 2000 || searchAnio.value> 2024){
                ...
                try {
                    const response = await axios.get(`https://newjeans-back.onrender.com/api/reportes/documentos/anio/${searchAnio.value}`, {
                        headers: {
                            Authorization: `Bearer ${token}`
                        }
                    });
...
const consultasPDF = async () => {
    try {
        const response = await axios.get('https://newjeans-back.onrender.com/api/reportes/pdf/consultas', {
            headers: {
                Authorization: `Bearer ${token}`
            },
            responseType: 'blob'
...
const docsPDF = async () => {
    if(tipoFilter.value){
        try {
            const response = await axios.get(`https://newjeans-back.onrender.com/api/reportes/pdf/documentos/tipo/${selectedTipo.value}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                responseType: 'blob'
        ...
        try {
            const response = await axios.get(`https://newjeans-back.onrender.com/api/reportes/pdf/documentos/anio/${searchAnio.value}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                responseType: 'blob'
        ...
        try {
            const response = await axios.get('https://newjeans-back.onrender.com/api/reportes/pdf/documentos', {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                responseType: 'blob'
