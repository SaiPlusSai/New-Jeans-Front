...
const loadUsers = async () => {
  ...
  loading.value = true
  try {
    const res = await axios.get('https://newjeans-back.onrender.com/api/usuarios-miga/todos', {
            headers: { Authorization: `Bearer ${token}` }
        })
...
const loadDeleted = async () => {
  ...
  try {
    const res = await axios.get('https://newjeans-back.onrender.com/api/usuarios-miga/eliminados', {
            headers: { Authorization: `Bearer ${token}` }
        })
...
const showOnlyMiga = async () => {
    if(onlyMiga.value){
        ...
        loading.value = true
        try {
            const res = await axios.get('https://newjeans-back.onrender.com/api/usuarios-miga/solo-miga', {
            headers: { Authorization: `Bearer ${token}` }
        })
            users.value = res.data
        } catch (err) {
...
const registerUser = async () => {
  ...
  try {
    ...
    if(isMiga.value){
      ...
      response = await axios.post('https://newjeans-back.onrender.com/api/usuarios-miga/registro-miga', newData, {
          headers: { Authorization: `Bearer ${token}` }
      })
      ...
      response = await axios.post('https://newjeans-back.onrender.com/api/usuarios/registro-comunidad', newData, {
          headers: { Authorization: `Bearer ${token}` }
      })
...
const updateUser = async () => {
  ...
  try {
    ...
    const response1 = await axios.patch(`https://newjeans-back.onrender.com/api/usuarios/${user.value.id}`, updatedData, {
                            headers: { Authorization: `Bearer ${token}` }
                        })
    ...
    const response2 = await axios.put(`https://newjeans-back.onrender.com/api/usuarios-miga/${user.value.id}/rol`, newRol, {
                            headers: { Authorization: `Bearer ${token}` }
                        })
...
const deleteUser = async () => {
  try {
    await axios.put(`https://newjeans-back.onrender.com/api/usuarios-miga/${user.value.id}/eliminar`, {}, {
      headers: { Authorization: `Bearer ${token}` }
    })
...
const restoreUser = async () => {
  try {
    await axios.put(`https://newjeans-back.onrender.com/api/usuarios-miga/${user.value.id}/restaurar`, {}, {
      headers: { Authorization: `Bearer ${token}` }
    })
...
const restoreUserById = async (id) => {
  try {
    await axios.put(`https://newjeans-back.onrender.com/api/usuarios-miga/${id}/restaurar`, {}, {
      headers: { Authorization: `Bearer ${token}` }
    })
...
const searchUsers = async () => {
  ...
  if(regexes.email.test(searchWord.value) || regexes.username.test(searchWord.value) || regexes.id.test(searchWord.value)){
    ...
    try {
      ...
      const url = `https://newjeans-back.onrender.com/api/usuarios/buscar-identificador?valor=${encodedWord}`
    ...
    try {
      const encodedWord = encodeURIComponent(searchWord.value)
      const url = `https://newjeans-back.onrender.com/api/usuarios/buscar-google?frase=${encodedWord}`
      const response = await axios.get(url, {
        headers: { Authorization: `Bearer ${token}` }
      })
      users.value = response.data
...
const loadMacros = async () => {
  try {
    const res = await axios.get("https://newjeans-back.onrender.com/api/macrodistritos")
...
const loadZonas = async(idMacro) => {  
  ...
  try {
    const res = await axios.get(`https://newjeans-back.onrender.com/api/macrodistrito/${idMacro}/zonas`)
...
const loadAmbitos = async() => {
  try {
    const res = await axios.get("https://newjeans-back.onrender.com/api/ambitos")
