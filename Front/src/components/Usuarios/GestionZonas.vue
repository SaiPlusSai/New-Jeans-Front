...
const cargarZonas = async () => {
  ...
  try {
    const res = await axios.get(`https://newjeans-back.onrender.com/api/macrodistrito/${selectedMacroId.value.id}/zonas`, {
      headers: { Authorization: `Bearer ${token}` }
    })
...
const cargarZonasEliminadas = async () => {
  try {
    const res = await axios.get('https://newjeans-back.onrender.com/api/zonas', {
      headers: { Authorization: `Bearer ${token}` }
    })
...
const crearZona = async () => {
  ...
  try {
    ...
    const res = await axios.post('https://newjeans-back.onrender.com/api/zonas', data, {
      headers: { Authorization: `Bearer ${token}` }
    })
...
const actualizarZona = async (id, nuevoNombre) => {
  try {
    const res = await axios.put(`https://newjeans-back.onrender.com/api/zonas/${id}`, {
      nombre: nuevoNombre
    }, {
      headers: { Authorization: `Bearer ${token}` }
    })
...
const restaurarZona = async (zona) => {
  try {
    const res = await axios.put(`https://newjeans-back.onrender.com/api/zonas/${zona.id}`, {
...
const eliminarZona = async (id) => {
  try {
    await axios.delete(`https://newjeans-back.onrender.com/api/zonas/${id}`, {
      headers: { Authorization: `Bearer ${token}` }
    })
